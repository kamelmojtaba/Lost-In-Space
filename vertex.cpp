...
//--------------------------------------------------------------------
void vertex::DisplayTexture(float transparent)
{
    float x1, y1, z1;
    float x2, y2, z2;
    float x3, y3, z3;
    ...
    for (int i = 0; i < noOfFaces; i++) {
        ...
        glTexCoord2f(sr_verts[tri_triags[i].tv[0]].uv[0], sr_verts[tri_triags[i].tv[0]].uv[1]);
        glVertex3f(x1, y1, z1);

        glTexCoord2f(sr_verts[tri_triags[i].tv[1]].uv[0], sr_verts[tri_triags[i].tv[1]].uv[1]);
        glVertex3f(x2, y2, z2);

        glTexCoord2f(sr_verts[tri_triags[i].tv[2]].uv[0], sr_verts[tri_triags[i].tv[2]].uv[1]);
        glVertex3f(x3, y3, z3);
    }
    glEnd();
...
//--------------------------------------------------------------------
void vertex::DisplayWireFrame(float transparent)
{
    float x1,y1,z1;
    float x2,y2,z2;
    float x3,y3,z3;
